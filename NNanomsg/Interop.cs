...
namespace NNanomsg
{
    ...
    public static class NanomsgLibraryLoader
    {
        ...
        private static string calculatexdir(string assemblyPath, string framework, string libFile)
        {
        ...
        private static IntPtr LoadWindowsLibrary(string libName, out SymbolLookupDelegate symbolLookup)
        {
    ...
    internal static unsafe class Interop
    {
        ...
        private static void InitializeDelegates(IntPtr nanomsgAddr, NanomsgLibraryLoader.SymbolLookupDelegate lookup)
        {
